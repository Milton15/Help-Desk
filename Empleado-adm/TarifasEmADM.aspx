<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TarifasEmADM.aspx.cs" Inherits="Menu_Tarifas" %>
            ...
            <div class="main">
                    ...
                    <div class="indent">
                        ...
                        <nav>
                            <ul class="menu">
                                ...
                                <li><a class="active" href="TarifasEmADM.aspx">Tarifas</a></li>
                ...
                <section id="content">
                    <div class="indent-left">
                        <h3 class="p1">Nuestros Precios</h3>
                        <div class="wrapper">
                            <div class="col-1">
                                <ul class="price-list">
