<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Contacto.aspx.cs" Inherits="Menu_Contacto" %>
                ...
                <div class="indent">
                    ...
                    <nav>
                        <ul class="menu">
                            ...
                            <li class="last"><a class="active" href="Contacto.aspx">Contacto</a></li>
                        </ul>
                    </nav>
                </div>
            </header>
                                ...
                                <fieldset>
                                    ...
                                    <div class="auto-style2">
                                        ...
                                        <div class="extra-wrap">
                                            <asp:TextBox ID="txtMensaje" TextMode="multiline" Style="resize: none" Width="600px" Height="150px" Wrap="true" runat="server" Font-Size="Large" />
                                        </div>
                                    </div>
                                    <div class="buttons">
